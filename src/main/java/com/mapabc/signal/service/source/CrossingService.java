...
public interface CrossingService {
    ...
    */
    VendorResult<DetectorVo> queryDetector(ParamEntity<List<BaseSignal>> param);
     ...
     * @date 2019/4/19 14:49
     */
    VendorResult<PhasePlanVo> queryPhasePlan(ParamEntity<List<BaseSignal>> param);
     ...
     * @date 2019/4/19 14:49
     */
    VendorResult<TimePlanVo> queryTimePlan(ParamEntity<List<BaseSignal>> param);
     ...
     * @date 2019/4/19 14:49
     */
    VendorResult<SectionPlanVo> querySectionPlan(ParamEntity<List<BaseSignal>> param);
     ...
     * @date 2019/4/19 14:49
     */
    VendorResult<RunplanVo> queryRunPlan(ParamEntity<List<BaseSignal>> param);
}
