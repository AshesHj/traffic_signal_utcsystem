...
public interface SignalRunService {
    ...
    */
    VendorResult<SignalRunStatusVo> queryRunState(ParamEntity<List<BaseSignal>> param);
     ...
     * @date 2019/4/22 17:09
     */
    VendorResult<SignalAlarmsVo> queryAlarms(ParamEntity<List<BaseSignal>> param);
     ...
     * @date 2019/4/22 17:09
     */
    VendorResult<SignalInfoVo> querySignalInfo(ParamEntity<List<BaseSignal>> param);
     ...
     * @date 2019/4/22 17:09
     */
    VendorResult<SignalVolumeVo> querySignalVolume(ParamEntity<List<BaseSignal>> param);
}
