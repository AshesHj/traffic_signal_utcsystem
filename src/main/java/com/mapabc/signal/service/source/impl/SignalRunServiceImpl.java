...
public class SignalRunServiceImpl implements SignalRunService {
     ...
     */
    @Override
    public VendorResult<SignalRunStatusVo> queryRunState(ParamEntity<List<BaseSignal>> param) {
        //请求接口地址
     ...
     */
    @Override
    public VendorResult<SignalAlarmsVo> queryAlarms(ParamEntity<List<BaseSignal>> param) {
        //请求接口地址
     ...
     */
    @Override
    public VendorResult<SignalInfoVo> querySignalInfo(ParamEntity<List<BaseSignal>> param) {
        //请求接口地址
     ...
     */
    @Override
    public VendorResult<SignalVolumeVo> querySignalVolume(ParamEntity<List<BaseSignal>> param) {
        //请求接口地址
